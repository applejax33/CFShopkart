...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<cfoutput>
				...
				<div class="clear"></div>
				<div class="blog_post">Posted By #qry_blogsettings.blog_owner# at #TimeFormat(blog_time, "h:mm tt")# in Category:<a href="index.cfm?template=#template#&isplugin=yes&action=blog.blog_showCategory&blog_cat=category=#qry_blogCategory.blog_cat_id#">#qry_blogCategory.blog_cat_name#</a></div>
				<div class="clear"></div>
			</cfoutput>
			<div class="clear"></div>
		</cfloop>
