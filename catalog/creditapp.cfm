<form action="index.cfm?action=credit_apply" method="post">
<table width="84%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr bgcolor="lightgrey">
    ...
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="state" type="text" size="14" />
    </font></td>
  ...
  <tr bgcolor="white">
    ...
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input type="text" name="traderef1" />
    </font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">Telephone</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="tradephone1" type="text" size="12" />
    </font></td>
    <td nowrap="nowrap"><font size="2" face="Arial, Helvetica, sans-serif">Account No.</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="tradeacct1" type="text" size="14" />
    </font></td>
    </tr>
   <tr bgcolor="lightgrey">
    <td nowrap="nowrap"><font size="2" face="Arial, Helvetica, sans-serif">Name</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input type="text" name="traderef2" />
    </font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">Telephone</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="tradephone2" type="text" size="12" />
    </font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">Account No.</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="tradeacct2" type="text" size="14" />
    </font></td>
    </tr>
   <tr bgcolor="white">
    <td nowrap="nowrap"><font size="2" face="Arial, Helvetica, sans-serif">Name</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input type="text" name="traderef3" />
    </font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">Telephone</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="tradephone3" type="text" size="12" />
    </font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">Account No.</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="tradeacct3" type="text" size="14" />
    </font></td>
    </tr>
  <tr bgcolor="lightgrey">
    <td nowrap="nowrap"><font size="2" face="Arial, Helvetica, sans-serif">Credit line requested $</font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="creditline" type="text" size="10" />
    </font></td>
    ...
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      ...
      <select name="terms" id="terms">
        ...
        <option value="15 Days 5%">15 Days 5%</option>
        <option value="7 Days 7.5%">7 Days 7.5%</option>
      </select>
      </label>
    </font></td>
    <td><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
