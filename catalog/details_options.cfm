    ...
    <cfset OptionsHTML = ''>					
		...
		<!---build the HTML for this option--->
            ...
            <cfset optionsHTML = #OptionsHTML# & '<select name="ffield#OptionID#" size="#height#">'>
                ...
                <cfset op_itemid = #qryOptions.itemid#>
            ...
            <cfif FieldType IS 'checkbox'>
	            <cfif showoption IS 1> <!---checkboxes can be used to track inventory so we hide it if it's out of stock (see code above and comments)--->
                    <tr class="Options"> 								
                        <td colspan="2" class="option_cell"><span class="options_field">#optionsHTML#</span></td>
                    </tr>
				</cfif>
			<cfelse>
			<tr class="Options"> 
				<td class="option_cell"><span class="options_labels">#caption#</span></td>
				<td class="option_cell"><span class="options_field">#optionsHTML#</span></td>
			</tr>
            </cfif>
		</cfoutput>
</table>
