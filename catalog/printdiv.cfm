<!---***for printing***--->
<div id = "print_details" style="display:none;">
<style>
.printdiv {font-family: Geneva, Arial, Helvetica, sans-serif;
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
	<cfif fileexists('#request.catalogpath#docs#request.bslash#printitem_header.cfm')>
    <tr>
    <td colspan="2">
    	<cfinclude template = '../docs/printitem_header.cfm'>
    </td>
    </tr>
    </cfif>
    <tr> 
