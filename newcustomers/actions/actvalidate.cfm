<cfif NOT isdefined('form.lastname')>
	<cflocation url = "index.cfm?action=newcustomer">
</cfif>
<!---Validates the information entered into the checkout form--->
<cfset URLString = '?CartToken=#CartToken#'>
...
<cfset URLString = URLString & '&ErrorMessage=#ErrorMessage#&TotalErrors=#TotalErrors#&ErrorList=#ErrorList#&action=NewCustomer'>
