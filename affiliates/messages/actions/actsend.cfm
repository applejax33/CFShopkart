...
VALUES
('#qryLogin.AffiliateID#', '#qryLogin.AffiliateID#', '#CurrentRecipient#', '#form.subject#', '#form.body#', 'No', '#TheDateNow# #TheTimeNow#', 'No', '#form.ToField#')
</cfquery>
...
VALUES
('#qryLogin.AffiliateID#', '#form.subject#', '#form.body#', '#TheDateNow# #TheTimeNow#', '#form.ToField#')
</cfquery>
