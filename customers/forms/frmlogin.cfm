...
<cfparam name = "message_txt" default="Please login to your account.">
    ...
    <tr> 
      <td valign="top"> <form <cfoutput>action = "index.cfm?action=myaccount&carttoken=#carttoken#"</cfoutput> method="POST">
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="0">
          <tr> 
            <td colspan="3"><cfoutput>#message_txt#</cfoutput></td>
          </tr>
          <tr> 
            <td colspan="3"><font size="1"> 
              ...
              <font color="#FF0000" size="1"></div> </font><font size="1"> 
