<!--- authorize.net subscription management--->

<cfcomponent displayname="anarb.cfc" hint="Version .3. Provides Authorize.net recurring billing functionality">

	<cffunction name="init" access="public" returntype="anarb">
	...
	<cffunction name="createSubscription" access="public" displayname="Creates a recurring subscription">
		...
		<cfargument name="cardCode" type="string" required="No" />
	...
	<cffunction name="createXML" hint="Generates the XML used for creating/updating" access="private" returntype="string">
		...
		<cfif IsDefined("Arguments.chargeType") AND Arguments.chargeType EQ "cc">
			...
			<cardCode>#Arguments.cardCode#</cardCode>
			</creditCard>
			</payment>
			</cfoutput>
			</cfsavecontent>
