                          ...
                          <cfoutput query = "response">
                            <cfif ServicesList CONTAINS '#ServiceCode#'>
                              <cfif request.EnableEuro IS 'Yes'>
                                ...
                                <option value="#Service#, #totalrate#" <cfif Service CONTAINS #Cart.DefaultService#>selected="selected"</cfif>>#Service# - #lseurocurrencyformat(rate, "Local")#</option>
                              </cfif>
                              <cfif request.EnableEuro IS 'No'>
                                <cfset totalrate = rate + cart.Surcharges>
                                <option value="#Service#, #totalrate#" <cfif Service CONTAINS #Cart.DefaultService#>selected="selected"</cfif>>#Service# 
