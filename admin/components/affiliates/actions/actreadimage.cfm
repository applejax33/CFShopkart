...
<cfif request.ImageProcessor IS 'cfx_imagecr3'>
	...
	<cfx_imagecr3 GetImageInfo = "#request.Catalogpath#images#request.bslash#banners#request.bslash##photo#">
...
<cfif request.ImageProcessor IS 'ImageJ'>
	...
	image.open("#request.Catalogpath#images#request.bslash#banners#request.bslash##photo#");
...
<cfif request.ImageProcessor is 'cfximage'>
	<CFX_Image Action = "Read" File="#request.Catalogpath#images#request.bslash#banners#request.bslash##photo#">
...
<cfif request.ImageProcessor is 'cfx_openimage'>
	<CFX_OpenImage Action = "Read" File="#request.Catalogpath#images#request.bslash#banners#request.bslash##photo#">
		<cfset iHeight = #IMG_HEIGHT#>
		<cfset iWidth = #IMG_WIDTH#>
</cfif>
...
<cfif request.ImageProcessor is 'cfxjpegresize'>
   ...
   <CFX_ImageInfoMX FILE="#request.Catalogpath#images#request.bslash#banners#request.bslash##photo#">
